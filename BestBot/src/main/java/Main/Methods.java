...
public class Methods {
	 ...
	 * int randomNumber = 0; // default wert int max = 10;
	 * 
	 * new randomNumber();// TODO muss neue Nachricht einlesen und in max speichern
	 * 
	 * /* objCh.sendMessage("Max?").queue(); try { // Bitte beheben! } catch
	 * (Exception invalidInput) { objCh.sendMessage("Invalid Input.").queue();
